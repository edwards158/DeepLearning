...
* [Sentiment Analysis with Numpy](https://github.com/riched158/DeepLearning/tree/master/first-neural-network): Build a sentiment analysis model, predicting if some text is positive or negative.
